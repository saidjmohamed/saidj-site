...
const PerformanceOptimizer: React.FC = () => {
  ...
  // Monitor Core Web Vitals (simplified to avoid build errors)
  const monitorCoreWebVitals = useCallback(() => {
    ...
    try {
      ...
      // Only observe if first-input is supported
      try {
        fidObserver.observe({ entryTypes: ['first-input'] });
      } catch (e) {
        console.log('First input measurement not available');
      }
  ...
  // Service Worker with advanced caching strategies (simplified)
